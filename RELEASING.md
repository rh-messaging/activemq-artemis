...
What is the new development version for "ActiveMQ Artemis Parent"? (artemis-pom) 2.27.1-SNAPSHOT: : 2.28.0-PATCH-3251-SNAPSHOT
```

Otherwise snapshots would be created at 2.27.1-SNAPSHOT and left to go stale rather than get cleaned out if the next release is actually 2.28.0-PATCH-3251. (Unless we did ever release 2.27.1 in that example).
