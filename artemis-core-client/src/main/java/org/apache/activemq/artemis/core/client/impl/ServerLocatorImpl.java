...
public final class ServerLocatorImpl implements ServerLocatorInternal, DiscoveryListener {
   ...
   public ClientSessionFactory createSessionFactory(final TransportConfiguration transportConfiguration) throws Exception {
      ...
      ClientSessionFactoryInternal factory = new ClientSessionFactoryImpl(this, transportConfiguration, config, config.reconnectAttempts, threadPool, scheduledThreadPool, incomingInterceptors, outgoingInterceptors);
   ...
   public boolean isFailoverOnInitialConnection() {
      return this.config.failoverOnInitialConnection;
   }

   @Override
   public ServerLocatorImpl setFailoverOnInitialConnection(final boolean failover) {
      checkWrite();
      this.config.failoverOnInitialConnection = failover;
      return this;
   }
