...
Please note, the connection url and properties are different please see https://artemis.apache.org/components/artemis/migration-documentation/[Migration Documentation]
