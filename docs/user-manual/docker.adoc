...
The official Docker images are built using https://github.com/apache/artemis/tree/main/artemis-docker[these scripts] which you can also use to build your own images.
