...
public class SecurityOpenWireTest extends BasicOpenWireTest {
   ...
   protected void extraServerConfig(Configuration configuration) {
      ...
      configuration.addQueueConfiguration(new QueueConfiguration(ALTERNATE_QUEUE).setAddress(ALTERNATE_ADDRESS).setRoutingType(RoutingType.ANYCAST));
      ...
      configuration.addQueueConfiguration(new QueueConfiguration(FQQN_FOR_USER1).setAddress(FQQN_ADDRESS).setRoutingType(RoutingType.ANYCAST));
      configuration.addQueueConfiguration(new QueueConfiguration(FQQN_FOR_USER2).setAddress(FQQN_ADDRESS).setRoutingType(RoutingType.ANYCAST));
   }
