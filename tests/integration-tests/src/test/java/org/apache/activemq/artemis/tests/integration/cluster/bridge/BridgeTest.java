...
public class BridgeTest extends ActiveMQTestBase {
   ...
   public void testClientSessionFactoryLeak() throws Exception {
      ...
      server0.getConfiguration().setQueueConfigs(List.of(new QueueConfiguration(queueName0).setAddress(testAddress)));
   ...
   private void testPendingAcksNeverArrive(boolean stop, boolean large) throws Exception {
      ...
      server0.getConfiguration().setQueueConfigs(Arrays.asList(new QueueConfiguration(queueName0).setAddress(testAddress)));
      server0.start();
      ...
      server1.getConfiguration().setQueueConfigs(Arrays.asList(new QueueConfiguration(queueName1).setAddress(forwardAddress)));
      server1.start();
