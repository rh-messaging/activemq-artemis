...
public class PageConstants {
   ...
   public static final String A_CONTAINS_TEXT_LOG_OUT = "//a[contains(text(),'Log out')]";
   ...
   public static final String DEFAULT_CONSOLE_LOGIN_BRAND_IMAGE = "http://localhost:8161/console/img/activemq.png";

   public static final By BRAND_LOCATOR = By.xpath("//img[@class='pf-c-brand']");
   ...
   public static final By TABLE_ROW_LOCATOR = By.cssSelector("tr[data-ouia-component-type='PF4/TableRow']");
   ...
   public static final By SEND_MESSAGE_BUTTON = By.xpath("//button[contains(text(),'Send Message')]");
   ...
   public static final By SEND_MESSAGE_TITLE = By.xpath("//h1[contains(text(),'Send Message')]");
   ...
   public static final By NODE_TITLE_LOCATOR = By.cssSelector("h1[data-ouia-component-type='PF4/Title']");
